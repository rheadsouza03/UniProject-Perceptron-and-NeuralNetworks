...
class Neural_Network:
    ...
    def backward_propagate_error(self, inputs, hidden_layer_outputs, output_layer_outputs, desired_outputs):
        ...
        hidden_layer_betas = np.dot(output_layer_betas, self.output_layer_weights.T) * self.sigmoid_derivative(hidden_layer_outputs)
    ...
    def train(self, instances, desired_outputs, epochs):
        for epoch in range(epochs):
            ...
            # Print running loss for this epoch
